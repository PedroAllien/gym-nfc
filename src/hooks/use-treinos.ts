...
function treinoExercicioFromRow(row: any, exercicio: any): TreinoExercicio {
  return {
    ...
    exercicio: {
      ...
      videoUrl: exercicio.video_url ?? undefined,
      externalVideoUrl: exercicio.external_video_url ?? undefined,
      youtubeUrl: exercicio.youtube_url ?? undefined,
      youtubeId: exercicio.youtube_id ?? undefined,
      thumbnail: exercicio.thumbnail ?? undefined,
