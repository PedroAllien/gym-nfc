...
import { useCategoria, useUpdateCategoria } from '@/hooks/use-categorias';
...
export default function EditarCategoriaPage() {
  ...
  if (!categoria) {
    return <div className="text-gray-600 dark:text-gray-400">Categoria não encontrada</div>;
  }

  return (
    <div>
      <h1 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6 text-gray-900 dark:text-white">Editar Categoria</h1>
